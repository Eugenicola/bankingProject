...
public class CheckingControllerImpl {
    ...
    public Account addNewCheckingAccount(@DateTimeFormat(pattern = "yyyy-MM-dd")@RequestBody @Valid Account account){
        return checkingServiceInterface.createAccount(account);
    }
}
