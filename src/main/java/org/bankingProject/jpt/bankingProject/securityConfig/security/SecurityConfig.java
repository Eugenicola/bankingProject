package org.bankingProject.jpt.bankingProject.securityConfig.security;

import lombok.RequiredArgsConstructor;
import org.bankingProject.jpt.bankingProject.securityConfig.filters.CustomAuthenticationFilter;
import org.bankingProject.jpt.bankingProject.securityConfig.filters.CustomAuthorizationFilter;
...
public class SecurityConfig {
    ...
    protected SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests((requests) -> requests
                ...
                .requestMatchers(GET, "/api/accountList").hasAnyAuthority("ROLE_ADMIN")
                ...
                .requestMatchers(PUT, "/api/updateBalance/{id}").hasAnyAuthority("ROLE_ADMIN")
